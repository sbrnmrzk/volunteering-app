...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase MyDB) {
        ...
        MyDB.execSQL("create Table profiles(ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT, emailAddress TEXT, password TEXT, profilePicture BLOB, avgRating REAL NOT NULL)");
    ...
    public void onUpgrade(SQLiteDatabase MyDB, int i, int i1) {
        ...
        MyDB.execSQL("drop Table if exists follow");
